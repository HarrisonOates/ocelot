...
namespace progression {
	...
	class Model {
		...
		public:
			...
			std::vector<char> factIsStatic;
			std::vector<char> factIsOrderingIndicator;
			...
			void setMaintainPlanStepTimings(bool enabled);
			bool isMaintainingPlanStepTimings() const;
    ...
    private:
			...
			int psID = 0;
			bool maintainPlanStepTimings = false;
