...
struct gengetopt_args_info
{
 ...
 help description.  */
  ...
  int orderOutput_flag;	/**< @brief when printing the plan also output the ordering constraints that the HTN structure imposes onto the plan (default=on).  */
  const char *orderOutput_help; /**< @brief when printing the plan also output the ordering constraints that the HTN structure imposes onto the plan help description.  */
  ...
  unsigned int orderOutput_given ;	/**< @brief Whether orderOutput was given.  */
