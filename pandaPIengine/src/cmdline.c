...
const char *gengetopt_args_info_help[] = {
  ...
  "      --orderOutput             when printing the plan also output the ordering\n                                  constraints that the HTN structure imposes\n                                  onto the plan  (default=on)",
...
const char *cmdline_parser_gValue_values[] = {"path", "action", "mixed", "none", "makespan", 0}; /*< Possible values for gValue. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->orderOutput_help = gengetopt_args_info_help[38] ;
  args_info->downward_help = gengetopt_args_info_help[40] ;
  args_info->downwardConf_help = gengetopt_args_info_help[41] ;
  args_info->transtype_help = gengetopt_args_info_help[42] ;
  args_info->forceTransType_help = gengetopt_args_info_help[43] ;
  args_info->sasfile_help = gengetopt_args_info_help[44] ;
  args_info->pgb_help = gengetopt_args_info_help[45] ;
  args_info->pgbsteps_help = gengetopt_args_info_help[46] ;
  args_info->onlyGenerate_help = gengetopt_args_info_help[47] ;
  args_info->iterate_help = gengetopt_args_info_help[48] ;
  args_info->realCosts_help = gengetopt_args_info_help[49] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->orderOutput_given)
    write_into_file(outfile, "orderOutput", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        action: summed cost of the applied actions
        makespan: plan makespan (critical path) of executed primitive actions
        none: constant zero.
.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* when printing the plan also output the ordering constraints that the HTN structure imposes onto the plan.  */
          else if (strcmp (long_options[option_index].name, "orderOutput") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->orderOutput_flag), 0, &(args_info->orderOutput_given),
                &(local_args_info.orderOutput_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "orderOutput", '-',
                additional_error))
              goto failure;
